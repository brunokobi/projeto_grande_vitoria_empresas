...
def filtros_comuns(
    ...
    processo_polo: list[str] = Query(None, description="Restringe o(s) polo(s) do processo (repita o parâmetro pra combinar mais de um): Réu (padrão quando com_processos e nenhum polo é informado), Autor, Terceiro, ou TODOS pra qualquer polo"),
    processo_classe: list[str] = Query(None, description="Restringe à(s) classe(s) exata(s) do processo — repita o parâmetro pra combinar mais de uma (ver GET /processos/classes)"),
    com_sancoes: bool = Query(None, description="Só empresas com sanções"),
    sancao_tipo: list[str] = Query(None, description="Restringe o(s) tipo(s) da sanção — repita o parâmetro pra combinar mais de um: CEIS/CNEP/CEPIM/TRABALHO_ESCRAVO/TCEES - Contas Irregulares, ou TODOS pra qualquer tipo"),
    ...
    vinculo_fonte: list[str] = Query(None, description="Restringe a(s) fonte(s) do vínculo — repita o parâmetro pra combinar: TSE_DOACAO (doação eleitoral), TSE_CANDIDATURA, ou TODOS"),
    com_contrato_pncp: bool = Query(None, description="Só empresas com contrato via PNCP (municipal/estadual/federal)"),
    pncp_categoria: list[str] = Query(None, description="Restringe à(s) categoria(s) exata(s) do contrato PNCP (ex.: Compras, Serviços, Obras...) — repita o parâmetro pra combinar mais de uma, ou TODOS"),
    ...
    beneficio_tipo: list[str] = Query(None, description="Restringe o(s) tipo(s) do benefício — repita o parâmetro pra combinar mais de um: RENUNCIA/IMUNE_ISENTO/HABILITADO/COMPETE_ES, ou TODOS"),
